    ...
    public class RoutingController
    {
       ...
       // public Socket receiver;
        ...
        private void chooseAction(string[] words)
        {
            ...
            {
                //TODO: Ostrzezenie ze zly format wiadomosci
            }
        }
        ...
        public void writeLog(string message)
        {
            ...
            Console.WriteLine(Timestamp.generateTimestamp() + " RC" + this.numberRC + " " + message);
        ...
        public void writeLogWithPath(string message, string stringPath)
        {
            ...
            Console.ForegroundColor = ConsoleColor.DarkGreen;
            Console.Write(Timestamp.generateTimestamp() + " RC" + this.numberRC + " " + message);
        ...
        {
            if (networkPath != null)
                return $"{this.ip}#{MessageNames.GET_PATH}#{PathToString(networkPath.path)}#{networkPath.path.frequency}#{networkPath.path.band}";
            else
            {
        ...
        public bool deallocateLink(string ip, int linkID, string in_or_out, short band, short frequency)
        {
            ...
            if (in_or_out == "ip")
            {
                ...
                return topology.network.wezly[nodeIndex].SNPP.snps[snpIndex].eonTable
        ...
        public void sendRouteTableQueryFailureMessage(string requestorIP, string pathFrom, string pathTo, short band)
        {
            ...
            string message = this.ip + "#" + MessageNames.FAILED_ROUTE_TABLE_QUERY + "#" + pathFrom + "#" +
